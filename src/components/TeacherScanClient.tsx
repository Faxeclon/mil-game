    ...
    <div className={`${styles.scan} app-chrome-hidden`}>
      ...
      */}
      {!closed && camera.kind !== "idle" && (
        <section aria-labelledby="scan-camera-title" className={styles.cameraBox}>
          ...
          */}
          ...
          {/* Each reason says what it was, and offers another go where another go can help. */}
          {camera.kind === "failed" && (
      ...
      {/*
        ...
        looks at. It appears once the answers close, where it says who got it right, and at
        no other moment.
      */}
      {closed && (
